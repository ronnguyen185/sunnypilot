...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"GateSOC2Enabled", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"GateSOC2Bus", {PERSISTENT | BACKUP, INT, "2"}},
    {"GateLatDelayS", {PERSISTENT | BACKUP, STRING, "0"}},
    {"GateSOC2BenchNoChassis", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"GateSOC2BenchLat", {PERSISTENT | BACKUP, STRING, "150"}},
    {"GateSOC2BenchLon", {PERSISTENT | BACKUP, STRING, "0"}},
    ...
    {"VinFastLateralOffset", {PERSISTENT | BACKUP, INT, "2"}},  // 0=Center, 1-3=Left (1=min, 3=max), 4-6=Right (4=min, 6=max)
