...
# Half car width in meters (1.08 * 1.1 = 1.188 for 10% increase)
HALF_CAR_WIDTH = 1.188
...
class LaneDepartureWarning:
  ...
  def update(self, frame, modelV2, CS, CC):
    ...
    if len(desire_prediction) and ldw_allowed:
      ...
      l_lane_close = left_lane_visible and (lane_lines[1].y[0] > -(HALF_CAR_WIDTH + CAMERA_OFFSET))
      r_lane_close = right_lane_visible and (lane_lines[2].y[0] < (HALF_CAR_WIDTH - CAMERA_OFFSET))
